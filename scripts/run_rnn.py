########################################################################################################
# RWKV-7 RNN-mode inference
# Based on RWKV-LM/RWKV-v7/rwkv_v7_demo_rnn.py
# No custom CUDA kernel needed — uses torch.compile (or torch.jit.script fallback)
########################################################################################################
...
########################################################################################################
# Model config — RNN script expects MODEL_NAME without .pth (appended in code)
########################################################################################################
