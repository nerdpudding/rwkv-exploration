########################################################################################################
# RWKV-7 GPT-mode inference
# Based on RWKV-LM/RWKV-v7/rwkv_v7_demo.py
# Requires CUDA kernel JIT compilation (wkv7)
########################################################################################################
...
import torch, types, gc, math, json
import numpy as np
...
########################################################################################################
# Model config — GPT script expects MODEL_PATH with .pth extension
########################################################################################################

args = types.SimpleNamespace()

# 0.1B g1d model
MODEL_PATH = os.path.join(PROJECT_ROOT, "Models", "rwkv7-g1", "rwkv7-g1d-0.1b-20260129-ctx8192.pth")
...
if USE_CUDA_KERNEL:
    ...
    load(name="wkv7", sources=[os.path.join(CUDA_DIR, "wkv7_op.cpp"), os.path.join(CUDA_DIR, "wkv7.cu")],
